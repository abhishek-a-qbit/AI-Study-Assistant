    ...
    const toggleListening = (setTextInput) => {
        if ('webkitSpeechRecognition' in window) {
            if (!recognitionRef.current) {
                const recognition = new new window.webkitSpeechRecognition();
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-100 to-indigo-100 font-inter text-gray-800 p-4 md:p-8">
            ...
            <div className="max-w-6xl mx-auto bg-white shadow-xl rounded-2xl p-6 md:p-10">
                ...
                {(isLoading || isQuizLoading || isExplanationLoading || isDailyTipLoading || isProgressLoading || isResourceCategoryLoading) && (
